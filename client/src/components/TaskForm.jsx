...
function TaskForm({ switchForm, ThemeStyles }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '65vh' }}>
      ...
      <h2 className="pb-12 text-2xl font-medium py-2 border-orange-950 px-4 text-slate-100 leading-30">Task Form</h2>
            ...
            <div key={field}>
              ...
              {field === "Description" ? (
                <textarea
                  ...
                  required
                  className="mt-1 block w-full px-3 py-2  border border-gray-300 rounded-md shadow-xl text-black focus:outline-none focus:ring-orange-900 focus:border-orange-900"
                  />
              ) : field === "deadline" ? (
                <input
                  id={field}
